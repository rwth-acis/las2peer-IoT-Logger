...
public class ServiceTest {
	...
	private static final String mainPath = "logger/";
	...
	public static void startServer() throws Exception {
		...
		ServiceAgent testService = ServiceAgent.createServiceAgent(LoggerClass.class.getName(), "a pass");
	...
	public void testGet() {
		...
		try {
			...
			ClientResponse result = c.sendRequest("GET", mainPath + "stateMQTT", "");
	...
	public void testPublish(){
		...
		try {
			...
			System.out.println("Result of 'testPublish': " + result.getResponse().trim());
		} catch (Exception e) {
			e.printStackTrace();
			fail("Exception: " + e);
		}
	...
	public void testDebugMapping() {
		LoggerClass cl = new LoggerClass();
